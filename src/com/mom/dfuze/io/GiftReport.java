...
public class GiftReport {
   ...
   * @param recordList
   */
  public static void writeHMAGiftReport(List<Record> recordList) {

    final String[] GIFT_REPORT_HEADER = new String[] { UserData.fieldName.FIRST_DONATION_DATE.getName(),
            UserData.fieldName.FIRST_DONATION_AMOUNT.getName(), UserData.fieldName.LAST_DONATION_AMOUNT.getName(),
            UserData.fieldName.LAST_DONATION_DATE.getName(), UserData.fieldName.DONATION1_AMOUNT.getName(),
            ...
            UserData.fieldName.MONTHLY_OPEN_DONATION_AMOUNT.getName(), UserData.fieldName.SEGMENT_CODE.getName() };
    ...
    for (int i = 0; i < sortedRecordList.size(); ++i) {
      ...
      giftReportOutput[row][++col] = new ExcelCell(record.getFstDnDat(), CellType.STRING, cellStyle, defaultFont, false);
      giftReportOutput[row][++col] = new ExcelCell(record.getFstDnAmt(), CellType.NUMERIC, cellStyle, defaultFont, false);
      ...
      giftReportOutput[row][++col] = new ExcelCell(record.getDn2Amt(), CellType._NONE, cellStyle, defaultFont, false);
      ...
      giftReportOutput[row][++col] = new ExcelCell(record.getMDn1Amt(), CellType.NUMERIC, cellStyle, defaultFont, false);
      giftReportOutput[row][++col] = new ExcelCell(record.getMDn2Amt(), CellType.NUMERIC, cellStyle, defaultFont, false);
      giftReportOutput[row][++col] = new ExcelCell(record.getMDn3Amt(), CellType.NUMERIC, cellStyle, defaultFont, false);
      giftReportOutput[row][++col] = new ExcelCell(record.getMODnAmt(), CellType._NONE, cellStyle, defaultFont, false);
   ...
   * @param recordList
   */
  public static void writeHMACCPAGiftReport(List<Record> recordList) {

    final String[] GIFT_REPORT_HEADER = new String[] { UserData.fieldName.LAST_DONATION_AMOUNT.getName(),
            UserData.fieldName.LAST_DONATION_DATE.getName(), UserData.fieldName.DONATION1_AMOUNT.getName(),
            UserData.fieldName.DONATION2_AMOUNT.getName(), UserData.fieldName.DONATION3_AMOUNT.getName(),
            UserData.fieldName.OPEN_DONATION_AMOUNT.getName(), UserData.fieldName.MONTHLY_DONATION1_AMOUNT.getName(),
            UserData.fieldName.MONTHLY_DONATION2_AMOUNT.getName(), UserData.fieldName.MONTHLY_DONATION3_AMOUNT.getName(),
    ...
    //XSSFCellStyle borderTop = wb.createCellStyle();
    //borderTop.setBorderTop(BorderStyle.THIN);
    //borderTop.setTopBorderColor(IndexedColors.BLACK.index);
   ...
   * @param recordList
   */
  public static void writeHMAGVFGiftReport(List<Record> recordList) {

    final String[] GIFT_REPORT_HEADER = new String[] { UserData.fieldName.FIRST_DONATION_DATE.getName(),
            UserData.fieldName.FIRST_DONATION_AMOUNT.getName(),UserData.fieldName.LAST_DONATION_DATE.getName(),
            UserData.fieldName.LAST_DONATION_AMOUNT.getName(), UserData.fieldName.LAST_MONTHLY_DONATION_AMOUNT.getName(), UserData.fieldName.DONATION1_AMOUNT.getName(),
            UserData.fieldName.DONATION2_AMOUNT.getName(), UserData.fieldName.DONATION3_AMOUNT.getName(),
            UserData.fieldName.OPEN_DONATION_AMOUNT.getName(), UserData.fieldName.MONTHLY_DONATION1_AMOUNT.getName(),
            UserData.fieldName.MONTHLY_DONATION2_AMOUNT.getName(), UserData.fieldName.MONTHLY_DONATION3_AMOUNT.getName(),
            UserData.fieldName.MONTHLY_OPEN_DONATION_AMOUNT.getName(), UserData.fieldName.SEGMENT_CODE.getName() };
    ...
    for (int i = 0; i < sortedRecordList.size(); ++i) {
      ...
      giftReportOutput[row][++col] = new ExcelCell(record.getLstDnDat(), CellType.STRING, cellStyle, defaultFont, false);
      giftReportOutput[row][++col] = new ExcelCell(record.getLstDnAmt(), CellType.NUMERIC, cellStyle, defaultFont, false);
      giftReportOutput[row][++col] = new ExcelCell(record.getLMDnAmt(), CellType.NUMERIC, cellStyle, defaultFont, false);
      giftReportOutput[row][++col] = new ExcelCell(record.getDn1Amt(), CellType.NUMERIC, cellStyle, defaultFont, false);
      giftReportOutput[row][++col] = new ExcelCell(record.getDn2Amt(), CellType.NUMERIC, cellStyle, defaultFont, false);
      giftReportOutput[row][++col] = new ExcelCell(record.getDn3Amt(), CellType.NUMERIC, cellStyle, defaultFont, false);
      giftReportOutput[row][++col] = new ExcelCell(record.getODnAmt(), CellType._NONE, cellStyle, defaultFont, false);
