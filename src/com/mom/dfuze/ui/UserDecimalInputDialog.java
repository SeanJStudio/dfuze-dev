...
public class UserDecimalInputDialog extends JDialog {
	...
	public UserDecimalInputDialog(Frame frame, String inputDescription) {
		...
		((AbstractDocument) textField.getDocument()).setDocumentFilter(new DecimalDocumentFilter(99));
		...
		public void actionPerformed(ActionEvent e) {
			try {
				if (e.getSource() == btnNext) {
					...
					throw new ApplicationException(String.format("ERROR: field can not be blank."));

					setIsNextPressed(true);
					UserDecimalInputDialog.this.dispose();
				}
			} catch (Exception err) {
