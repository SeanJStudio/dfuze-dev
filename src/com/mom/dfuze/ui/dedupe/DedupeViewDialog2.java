...
public class DedupeViewDialog2 extends JDialog {
  ...
  private DedupeTableModel2 dedupeTableModel;
  ...
  private DedupeDialog2 dedupeDialog;

  public DedupeViewDialog2(DedupeDialog2 dedupeDialog, ArrayList<Record> dupes, String[] selectedFields) {
  ...
  public DedupeTableModel2 getDedupeTableModel() {
    return dedupeTableModel;
  }

  public void setDedupeTableModel(ArrayList<Record> dupes) {
    dedupeTableModel = new DedupeTableModel2(dedupeDialog, dupes, selectedFields);
  }
