...
public class DedupeTableModel2 extends AbstractTableModel {
  ...
  public DedupeTableModel2(DedupeDialog2 dedupeDialog, ArrayList<Record> dupes, String[] selectedFields) {
	dupeMap = new HashMap<>();
    this.dupes = dupes;
