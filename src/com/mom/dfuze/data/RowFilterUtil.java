    ...
    public static JTextField createRowFilter(JTable table) {
        ...
        tf.getDocument().addDocumentListener(new DocumentListener() {
            ...
            private void update(DocumentEvent e) {
                ...
                try { // helper to avoid textfield glitching out cause by exceptions being thrown on bad regex patterns
                	@SuppressWarnings("unused")
					Pattern pattern = Pattern.compile("(?i)" + text, Pattern.CASE_INSENSITIVE);
