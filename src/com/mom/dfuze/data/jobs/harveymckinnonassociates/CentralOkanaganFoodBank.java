...
/**
 * 
 * CentralOkanaganFoodBank implements a RunBehavior for Harvey Mckinnon Associates Jobs
 * 
 * @author Sean Johnson
 ...
 *
 */
public class CentralOkanaganFoodBank implements RunHarveyMckinnonAssociatesBehavior {
	private final String SEGMENT_PLAN = "1";
	private String BEHAVIOR_NAME = "COFB";
	...
	public void run(UserData userData) throws Exception {
		...
		for (int i = 0; i < data.length; ++i) {
			...
			String fDnDat = "";
			String fstDnAmt = "";
			String lDnDat = fixDateFormat(data[i][userData.getLstDnDatIndex()].split(" ")[0]);
			...
			boolean recIsBusiness = (recType.trim().toLowerCase().startsWith("c")) ? true : false;
			...
			for (int j = 0; j < segmentPlanList.size(); ++j) {
					...
					if (sp.getIsStandardAsk()) {
						...
						BigDecimal newLastGiftAmt = new BigDecimal(lstDnAmt);
							...
							if (newLastGiftAmt.doubleValue() < 50.00) {
								...
								dn2Amt = "50";
								dn3Amt = "100";
								oDnAmt = "I prefer to give $ _________";
								...
								dn2Amt = "";
								dn3Amt = "";
								oDnAmt = "Please accept my gift of $ _________";
							}
				...
				if (sp.getIsStandardMonthlyAsk()) {
					...
					if (newLastGiftAmt.doubleValue() < 50.00) {
						...
						mDn2Amt = "15";
						mDn3Amt = "20";
						mODnAmt = "I prefer to give $ _____/mo";
					} else if (newLastGiftAmt.doubleValue() < 100.00) {
						mDn1Amt = "10";
						mDn2Amt = "15";
						mDn3Amt = "25";
	...
	private String fixDateFormat(String oldDate) {
		final String OLD_FORMAT = "yyyy-MM-dd";
		final String NEW_FORMAT = "M/d/yyyy";

		String newDateString = oldDate;
