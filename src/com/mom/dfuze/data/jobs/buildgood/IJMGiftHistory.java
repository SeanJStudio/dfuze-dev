...
public class IJMGiftHistory {
	private String id;
	private double giftAmount;
	private LocalDate giftDate;
	private String giftCampaign;
	
	public IJMGiftHistory() {}
	
	public IJMGiftHistory(String id, double giftAmount, LocalDate giftDate, String giftCampaign) {
		this.id = id;
	...
	public String toString() {
		return "IJMGiftHistory [id=" + id + ", giftAmount=" + giftAmount + ", giftDate=" + giftDate + ", giftCampaign="
				+ giftCampaign + "]";
	}
